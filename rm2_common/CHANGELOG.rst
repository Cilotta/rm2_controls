^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
Changelog for package rm2_common
...
/decision/service_caller.h
  #	rm2_msgs/CMakeLists.txt
  #	rm2_msgs/msg/referee/GameRobotStatus.msg
  #	rm2_msgs/msg/referee/GameStatus.msg
...
/decision/service_caller.h
  	rm2_msgs/msg/referee/CalibrationStatus.msg
  	rm2_msgs/msg/referee/CapacityData.msg
  	rm2_msgs/msg/referee/DetectionStatus.msg
  	rm2_msgs/msg/referee/EngineerCmd.msg
  	rm2_msgs/msg/referee/GameRobotHp.msg
  	rm2_msgs/msg/referee/GameRobotStatus.msg
  	rm2_msgs/msg/referee/GameStatus.msg
  	rm2_msgs/msg/referee/PowerHeatData.msg
  	rm2_msgs/msg/referee/StateCmd.msg
...
* Put computing acceleration into rm2_common
...
* Move gpio type from rm_hw to rm2_common
...
* Merge pull request `#7 <https://github.com/rm-controls/rm_control/issues/7>`_ from Peter-Chan-tech/master
  Move referee operations to rm2_common



* Remove serial lib in rm2_common



* Reformat
* Add new line at the end of files
* Move referee.cpp and referee.h to rm2_common



* Merge remote-tracking branch 'origin/master'
* Merge branch 'master' into master
* Use “pragma once” in rm2_common


 headers instead of include guards.
* Merge branch 'master' into master
