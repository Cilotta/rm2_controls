...
//
#include "rm2_referee/ui/graph.h"
...
Graph::Graph(const XmlRpc::XmlRpcValue& config, Base& base, int id) : base_(base)
{
  ...
  {
    config_.graphic_type = rm2_referee::GraphType::STRING;
  }
  ...
  {
    config_.color = rm2_referee::GraphColor::WHITE;
  }
  ...
  config_.operate_type = rm2_referee::GraphOperation::DELETE;
}
...
rm2_referee::GraphColor Graph::getColor(const std::string& color)
{
  if (color == "main_color")
    return rm2_referee::GraphColor::MAIN_COLOR;
  else if (color == "yellow")
    return rm2_referee::GraphColor::YELLOW;
  else if (color == "green")
    return rm2_referee::GraphColor::GREEN;
  else if (color == "orange")
    return rm2_referee::GraphColor::ORANGE;
  else if (color == "purple")
    return rm2_referee::GraphColor::PURPLE;
  else if (color == "pink")
    return rm2_referee::GraphColor::PINK;
  else if (color == "cyan")
    return rm2_referee::GraphColor::CYAN;
  else if (color == "black")
    return rm2_referee::GraphColor::BLACK;
  else
    return rm2_referee::GraphColor::WHITE;
}

rm2_referee::GraphType Graph::getType(const std::string& type)
{
  if (type == "rectangle")
    return rm2_referee::GraphType::RECTANGLE;
  else if (type == "circle")
    return rm2_referee::GraphType::CIRCLE;
  else if (type == "ellipse")
    return rm2_referee::GraphType::ELLIPSE;
  else if (type == "arc")
    return rm2_referee::GraphType::ARC;
  else if (type == "string")
    return rm2_referee::GraphType::STRING;
  else if (type == "int_num")
    return rm2_referee::GraphType::INT_NUM;
  else if (type == "float_num")
    return rm2_referee::GraphType::FLOAT_NUM;
  else if (type == "line")
    return rm2_referee::GraphType::LINE;
  else
    return rm2_referee::GraphType::LINE;
}
