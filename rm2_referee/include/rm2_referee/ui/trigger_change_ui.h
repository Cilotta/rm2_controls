...
public:
  ...
  {
    if (base.robot_id_ == rm2_referee::RobotId::RED_ENGINEER || base.robot_id_ == rm2_referee::RobotId::BLUE_ENGINEER)
  ...
  void updateManualCmdData(const rm2_msgs::ManualToReferee::ConstPtr data) override;
  void updateDbusData(const rm2_msgs::DbusData::ConstPtr& data);
...
public:
  ...
  void updateShootStateData(const rm2_msgs::ShootState::ConstPtr& data);
  void updateManualCmdData(const rm2_msgs::ManualToReferee::ConstPtr data) override;
...
public:
  ...
  void updateGimbalCmdData(const rm2_msgs::GimbalCmd ::ConstPtr& data);
  void updateManualCmdData(const rm2_msgs::ManualToReferee::ConstPtr data) override;
...
public:
  ...
  void updateFrictionSpeedUiData(const rm2_msgs::ShootCmdConstPtr& data);
