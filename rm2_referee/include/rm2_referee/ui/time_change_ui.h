...
public:
  ...
  void add() override;
  void updateRemainCharge(const double remain_charge, const rclcpp::Time& time);
...
public:
  ...
  void updateJointStateData(const sensor_msgs::JointState::ConstPtr data, const rclcpp::Time& time);
...
public:
  ...
  void updateEngineerUiData(const rm2_msgs::EngineerUi::ConstPtr data, const rclcpp::Time& last_get_data_time);
...
public:
  ...
  void updateDartClientCmd(const rm2_msgs::DartClientCmd::ConstPtr data, const rclcpp::Time& last_get_data_time);
...
public:
  ...
  void updateChassisCmdData(const rm2_msgs::ChassisCmd::ConstPtr data);
...
public:
  ...
  void calculatePointPosition(const rm2_msgs::BalanceStateConstPtr& data, const rclcpp::Time& time);
...
public:
  ...
  void updateBulletData(const rm2_msgs::BulletAllowance& data, const rclcpp::Time& time);
  void reset();
...
public:
  ...
  void updateTargetDistanceData(const rm2_msgs::TrackData::ConstPtr& data);
...
public:
  ...
  void updateBulletsData(const rm2_referee::BulletNumData& data);
